...
#       Load the banner image
        banner_img = Image.open(r"iteration2/assets/images/banner.png")
        banner_img = ImageTk.PhotoImage(banner_img)
        self.banner_image.append(banner_img)

        back_img = Image.open(r"iteration2/assets/images/back.png")
...
#   Save account details to external file
    def create_account(self):
        ...
        with open(r"iteration2/assets/details.txt", "a") as file:
...
#   Check if the details are correct before logging in
    def check_details(self):
        if self.entry_username.get() == "" or self.entry_password.get() == "":
            ...
            return
        try:
            with open(r"iteration2/assets/details.txt", "r") as file:
                for line in file:
...
#   Loads the images for the bins
    def load_images(self):
        img_rubbish = Image.open(r"iteration2/assets/images\rubbish.png")
        img_rubbish = img_rubbish.resize((130, 160))
        self.img_rubbish = ImageTk.PhotoImage(img_rubbish)
        self.images.append(self.img_rubbish)

        img_foodscraps = Image.open(r"iteration2/assets/images\foodscraps.png")
        ...
        if self.recycling:
            img_recycle = Image.open(r"iteration2/assets/images\recycle.png")
...
#   Save the changes made to the account
    def save_changes(self):
        ...
        if valid:
            ...
            with open(r"iteration2/assets/details.txt", "r") as file:
                data = file.readlines()
            with open(r"iteration2/assets/details.txt", "w") as file:
                for line in data:
...
#   Load the data from the external file
    def load_data(self):
        with open(r"iteration2/assets/data.json", "r") as file:
            data = json.load(file)
