...
namespace eval ttk::theme::forest-dark {
    ...
    ttk::style theme create forest-dark -parent default -settings {
        ...
        ttk::style configure TNotebook.Tab -padding {15 0 15 0} -font {TkDefaultFont 22}
        ...
        ttk::style element create Notebook.client image $I(notebook) -border 0

        ttk::style element create Notebook.tab image \
            [list $I(tab-basic) \
                selected $I(tab-accent) \
                active $I(tab-hover) \
            ] -border 10 -padding {14 4}
